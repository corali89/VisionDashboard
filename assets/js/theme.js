...
var getExactFolder = getExactUrl("packages"); //input the theme folder name or application folder name; sample output will be: /themes/mythemes/thema because it is uses in the javascript that has other path
    ...
    return {
        ...
        initWidgets: function() {
            ...
            if($('.widget #world-map-gdp-1').length) {
                ...
                var colors = ["rgba(173, 171, 171, .8)", "rgba(173, 171, 171, .6)", "rgba(173, 171, 171, .4)", "rgba(173, 171, 171, .)"];
